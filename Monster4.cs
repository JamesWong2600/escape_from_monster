...
public partial class Monster4 : CharacterBody2D
{
	// Called when the node enters the scene tree for the first time.
	public static Vector2 startPosition = new Vector2(4866f, 700f);
	...
	public static float Monster_cooldownTime = 15.0f; // Cooldown duration in seconds
